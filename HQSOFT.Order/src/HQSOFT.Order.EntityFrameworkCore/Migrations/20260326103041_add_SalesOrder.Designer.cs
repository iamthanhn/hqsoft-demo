...
namespace HQSOFT.Order.Migrations
{
    ...
    [Migration("20260326103041_add_SalesOrder")]
    partial class add_SalesOrder
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HQSOFT.Order.SaleOrders.SalesOrder", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppSaleOrders", (string)null);
                });

            modelBuilder.Entity("HQSOFT.Order.SaleOrders.SalesOrderLine", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("AppSaleOrderLines", (string)null);
                });
            ...
            modelBuilder.Entity("HQSOFT.Order.SaleOrders.SalesOrderLine", b =>
                {
                    b.HasOne("HQSOFT.Order.SaleOrders.SalesOrder", null)
                        .WithMany("OrderLines")
                        .HasForeignKey("OrderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.OwnsOne("HQSOFT.Order.SaleOrders.Money", "LineTotal", b1 =>
                        {
                            ...
                            b1.ToTable("AppSaleOrderLines");

                            b1.WithOwner()
                                .HasForeignKey("SalesOrderLineId");
                        });

                    b.OwnsOne("HQSOFT.Order.SaleOrders.Money", "UnitPrice", b1 =>
                        {
                            b1.Property<Guid>("SalesOrderLineId")
                                .HasColumnType("uuid");
